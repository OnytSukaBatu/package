...
void main() {
  group('Context-less Navigation Tests', () {
    testWidgets('Valenty.to navigates to new page', (WidgetTester tester) async {
    ...
    testWidgets('Valenty.off replaces current page', (WidgetTester tester) async {
       await tester.pumpWidget(ValentyApp(
         home: Scaffold(body: Text('Home')),
       ));
    ...
    testWidgets('Valenty.arguments passes arguments', (WidgetTester tester) async {
       await tester.pumpWidget(ValentyApp(
         home: Scaffold(body: Text('Home')),
       ));
       
       Valenty.to(
         Scaffold(body: Builder(builder: (c) => Text('Args: ${Valenty.arguments}'))),

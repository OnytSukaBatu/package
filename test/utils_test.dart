...
void main() {
  group('Context-less Utilities Tests', () {
    testWidgets('ValentyApp sets up global keys', (WidgetTester tester) async {
      await tester.pumpWidget(ValentyApp(home: Container()));
    ...
    testWidgets('Valenty.dialog shows dialog', (WidgetTester tester) async {
      ...
      // Trigger dialog
      Valenty.dialog(AlertDialog(title: Text('Test Dialog')));
    ...
    testWidgets('Valenty.bottomSheet shows bottom sheet', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(ValentyApp(home: Scaffold(body: Container())));

      Valenty.bottomSheet(Container(child: Text('Test BottomSheet')));

...
void main() {
  group('Reactive System Tests', () {
    ...
    testWidgets('Obx rebuilds when Rx variable changes', (WidgetTester tester) async {
       final count = 0.obs;
    ...
    testWidgets('Obx does not rebuild if unrelated Rx changes', (WidgetTester tester) async {
       final count1 = 0.obs;
       final count2 = 10.obs;
       int buildCount = 0;
